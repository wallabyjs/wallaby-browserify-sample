...
//CODE
let _ReadClss_CsdLimits = require('../src/ReadClss_CsdLimits');

describe(`_ReadClss_CsdLimits(STR) -> DCT:: returns a NAMED ReadClass CsdLimits DCT,
   e.g. Pst_CsdLimits`, function () {
    let Pst_CsdLimits = _ReadClss_CsdLimits('pst');// DCT -> STR -> DCT
